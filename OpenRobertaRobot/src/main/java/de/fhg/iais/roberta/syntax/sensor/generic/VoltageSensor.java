...
@NepoExpr(name = "VOLTAGE_SENSING", category = "SENSOR", blocklyNames = {"robSensors_battery_getSample", "robSensors_potentiometer_getSample", "robSensors_potentiometerrange_getSample"},
