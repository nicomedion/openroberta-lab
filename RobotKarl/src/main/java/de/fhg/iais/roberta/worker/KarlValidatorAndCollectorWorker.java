...
public class KarlValidatorAndCollectorWorker extends AbstractValidatorAndCollectorWorker {
    ...
    protected CommonNepoValidatorAndCollectorVisitor getVisitor(
        ...
        return new KarlValidatorAndCollectorVisitor(project.getConfigurationAst(), beanBuilders);
    }
